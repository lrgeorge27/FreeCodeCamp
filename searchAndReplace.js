...
// Input = a string
// Output = a string with one word changed

// split the string into an array
// loop through the array to find the before argument
// replace that word with the after argument
// join the array into a string

function myReplace(str, before, after) {
    var newStr = str.replace(before, after);
    //still need to preserve case
    return newStr;
}
